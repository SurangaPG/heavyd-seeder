 ...
 */
class ProjectPropertyCleanseTest extends AbstractDefaultDrupal8BaseTestCase {
  ...
  public function testPropertyCleanse() {
    $output = [];
    $return = $this->projectRunPhing('project:property-cleanse', $output);
    $this->markTestIncomplete('Cleaning out of the properties should be tested.');
  }
